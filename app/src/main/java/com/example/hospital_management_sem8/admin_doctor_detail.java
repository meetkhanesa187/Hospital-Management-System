...
public class admin_doctor_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Approved_Doctors");
        ...
        databaseReference.orderByKey().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    String age = snapshot.child("specialization").getValue(String.class);
                    String email = snapshot.child("email").getValue(String.class);
                    String mobileNumber = snapshot.child("mobileNumber").getValue(String.class);
                    String feedback = snapshot.child("bio").getValue(String.class);
                    ...
                    if (fullName != null && age != null && email != null) {
                        ...
                        patientInfo.append("🧑 Name: ").append(fullName).append("\n")
                                .append("🩺 Specialization: ").append(age).append("\n")
                                .append("📧 Email: ").append(email).append("\n")
                                .append("📞 Mobile: ").append(mobileNumber != null ? mobileNumber : "N/A").append("\n")
                                .append("💬 Bio: ").append(feedback != null ? feedback : "No more details").append("\n");
                ...
                if (patientDetails.isEmpty()) {
                    patientDetails.add("No doctors available.");
                }

                // Set up the adapter to display the patient data
                ArrayAdapter<String> adapter = new ArrayAdapter<>(admin_doctor_detail.this, android.R.layout.simple_list_item_1, patientDetails);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(admin_doctor_detail.this, "Failed to load doctor data", Toast.LENGTH_SHORT).show();
